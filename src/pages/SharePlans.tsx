...
const CONTEXT_SUGGESTIONS = [
  ...
  "Request your input on these plans",
];
...
export default function SharePlans() {
  ...
  useEffect(() => {
    console.log("SharePlans mounted, planIds:", planIds);
    loadContacts();
  }, []);

  // Debug: Log state changes
  useEffect(() => {
    console.log("State update - selectedContact:", selectedContact, "contacts.length:", contacts.length);
  ...
  const handleGenerateMessage = async () => {
    ...
    try {
      ...
      const response = await sharePlansAPI.generateMessage({
        plan_ids: planIds,
  ...
  const handleSendMessage = async () => {
    ...
    try {
      ...
      await sharePlansAPI.sharePlans({
        plan_ids: planIds,
      ...
      toast.success("Plans shared successfully!");
  ...
  console.log("SharePlans render - contacts:", contacts.length, "selectedContact:", selectedContact, "generatedMessage:", !!generatedMessage);
      ...
      <div className="flex-1 flex flex-col">
        ...
        <div className="px-4 py-4 border-b bg-farm-dark/95 backdrop-blur sticky top-0 z-10">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h2 className="font-semibold">Share Plans</h2>
              <p className="text-xs text-farm-muted">
                Sharing {planIds.length} plan{planIds.length !== 1 ? "s" : ""}
              </p>
            </div>
          </div>
        </div>
          ...
          {contacts.length > 0 && (
            <div>
              ...
              <Textarea
                ...
                placeholder="e.g., Please review and provide a quote"
                rows={3}
